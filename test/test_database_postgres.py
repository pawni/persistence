...
def session(output=''):
    ...
    engine = sqlalchemy.create_engine('postgresql://postgres:test@localhost:32768/testdb')
...
def test_seed(session):
    ...
    perturbation.database.seed('test/data', 'postgresql://postgres:test@localhost:32768/testdb', 'views.sql')
